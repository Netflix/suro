...
/**
 * Memory based implementation of {@link com.netflix.suro.sink.notification.Notification}
 *
 * @param <E> type of notification
 *
 * @author jbae
 */
public class QueueNotification<E> implements Notification<E> {
    ...
    public String getStat() {
        return String.format("QueueNotification with the size: %d, sent : %d, received: %d, dropped: %d",
